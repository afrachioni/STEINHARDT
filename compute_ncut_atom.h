...
ComputeStyle(ncut/atom,ComputeNCutAtom)

#else

#ifndef LMP_COMPUTE_NCUT_ATOM_H
#define LMP_COMPUTE_NCUT_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeNCutAtom : public Compute {
 public:
  ComputeNCutAtom(class LAMMPS *, int, char **);
  ~ComputeNCutAtom();
  void init();
