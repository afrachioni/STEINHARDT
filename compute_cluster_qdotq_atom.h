...
ComputeStyle(cluster_qdotq/atom,ComputeClusterQDotQAtom)

#else

#ifndef LMP_COMPUTE_CLUSTER_QDOTQ_ATOM_H
#define LMP_COMPUTE_CLUSTER_QDOTQ_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeClusterQDotQAtom : public Compute {
 public:
  ComputeClusterQDotQAtom(class LAMMPS *, int, char **);
  ~ComputeClusterQDotQAtom();
  void init();
